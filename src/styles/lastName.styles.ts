export const lastNameStyles = {
  ...
  table: {
    ...
    thCode: "px-6 py-4 font-bold w-[15%]",
    thType: "px-6 py-4 font-bold w-[15%]",
    thArticle: "px-6 py-4 font-bold w-[20%]",
    thCustomer: "px-6 py-4 font-bold w-[25%]",
    thStatus: "px-6 py-4 font-bold w-[10%] text-center",
  ...
  modal: {
    ...
    container: "relative w-full max-w-lg bg-space-900 rounded-2xl border border-space-500 shadow-2xl flex flex-col max-h-[90vh]",
