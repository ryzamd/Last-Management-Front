export const departmentStyles = {
  ...
  table: {
    ...
    thName: "px-6 py-4 font-bold w-[60%]",
    thStatus: "px-6 py-4 font-bold w-[20%] text-center",
    thAction: "px-6 py-4 font-bold text-right w-[20%]",

    tbody: "divide-y divide-space-800/50",
    tr: "hover:bg-space-800/30 transition-colors cursor-pointer group",
    tdHighlight: "px-6 py-4 text-sm font-mono text-white font-bold group-hover:text-emerald-300 transition-colors truncate",
    ...
    actionBtn: "p-2 rounded-lg transition-colors text-red-400 hover:bg-red-500/20",
  },

  modal: {
    overlay: "fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm animate-in fade-in",
    container: "relative w-full max-w-md bg-space-900 rounded-2xl border border-space-500 shadow-2xl flex flex-col max-h-[90vh]",
